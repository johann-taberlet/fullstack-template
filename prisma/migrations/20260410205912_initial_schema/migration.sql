...
-- CreateIndex
CREATE UNIQUE INDEX "ProjectClient_projectId_clientProfileId_key" ON "ProjectClient"("projectId", "clientProfileId");
...
-- AddForeignKey
ALTER TABLE "ProjectClient" ADD CONSTRAINT "ProjectClient_clientProfileId_fkey" FOREIGN KEY ("clientProfileId") REFERENCES "ClientProfile"("id") ON DELETE CASCADE ON UPDATE CASCADE;
